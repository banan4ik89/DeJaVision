...
import pause_menu as pause_menu_ui
from opengl_maze_core import (
    PLAYER_EYE_HEIGHT,
    TARGET_FPS,
    begin_overlay,
...
def start_tutor_maze_opengl(root=None):
    ...
    def get_ceiling_particle_color():
    ...
    def get_shot_hit_info(max_distance=12.0, step=0.025):
        ...
        while distance <= max_distance:
            ...
            if is_wall(sample_x, sample_y) and 0.0 <= sample_z <= 1.0:
            ...
            floor_z = get_floor_height(sample_x, sample_y)
            if sample_z <= floor_z + 0.01 and not is_wall(sample_x, sample_y):
                return {
                    "type": "floor",
                    "x": sample_x,
                    "y": sample_y,
            ...
            if sample_z >= CEILING_Z - 0.01 and not is_wall(sample_x, sample_y):
                return {
                    "type": "ceiling",
                    "x": sample_x,
                    "y": sample_y,
                    "z": CEILING_Z,
                    "dist": distance,
                    "color": get_ceiling_particle_color(),
                }
            distance += step
        return None
    ...
    while running:
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:
                    ...
                    if (
                        ...
                        ground_z = get_floor_height(player_x, player_y)
        ...
        if state["start_cutscene_active"]:
            ...
            target_crouch = CROUCH_MAX if crouching else 0.0
        ...
        draw_floor_and_ceiling(
            ...
            viewer_x=player_x,
            viewer_y=player_y,
            viewer_angle=player_angle,
            rear_cull=rear_world_culling_enabled,
        )
