...
from background_music import resume_music
...
def start_testing_maze(root=None):
    ...
    orbs = [
        {"x": 5.5, "y": 5.5, "color": "yellow"},
        {"x": 7.5, "y": 3.5, "color": "red"},
        {"x": 9.5, "y": 6.5, "color": "green"},
        {"x": 12.5, "y": 4.5, "color": "violet"},
    ]
    ...
    if next_action == "restart":
        return start_testing_maze(root)
